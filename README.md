...
* [OpenTUI](https://github.com/anomalyco/opentui) ⭐ 13,229 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-04 - The main OpenTUI project.
...
* [create-tui](https://github.com/msmps/create-tui) ⭐ 145 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-02 - A project generator for OpenTUI applications.
...
* [tuiparts.sh](https://github.com/tuiparts/tuiparts) ⭐ 255 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-02 - Primitive and recipe ecosystem for OpenTUI applications.
...
* [hunk](https://github.com/modem-dev/hunk) ⭐ 9,089 | 🐛 157 | 🌐 TypeScript | 📅 2026-09-04 - Review-first terminal diff viewer for agentic coders.
* [tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,291 | 🐛 75 | 🌐 Rust | 📅 2026-09-03 - A terminal interface for tracking token usage.
...
* [ghui](https://github.com/kitlangton/ghui) ⭐ 1,098 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-02 - A terminal UI for managing open GitHub pull requests across repositories.
...
* [termdraw](https://github.com/benvinegar/termdraw) ⭐ 310 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-04 - A terminal drawing editor for editable diagrams, UI mocks, and text graphics.
...
* [gloomberb](https://github.com/gloom-sh/gloomberb) ⭐ 2,036 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-04 - Financial terminal using OpenTUI for the layout.
