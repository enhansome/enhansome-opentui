...
* [OpenTUI](https://github.com/anomalyco/opentui) ⭐ 13,266 | 🐛 132 | 🌐 TypeScript | 📅 2026-09-09 - The main OpenTUI project.
...
* [hunk](https://github.com/modem-dev/hunk) ⭐ 9,192 | 🐛 150 | 🌐 TypeScript | 📅 2026-09-09 - Review-first terminal diff viewer for agentic coders.
* [tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,370 | 🐛 68 | 🌐 Rust | 📅 2026-09-09 - A terminal interface for tracking token usage.
...
* [termdraw](https://github.com/benvinegar/termdraw) ⭐ 311 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-08 - A terminal drawing editor for editable diagrams, UI mocks, and text graphics.
...
* [gloomberb](https://github.com/gloom-sh/gloomberb) ⭐ 2,116 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-09 - Financial terminal using OpenTUI for the layout.
