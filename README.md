...
* [OpenTUI](https://github.com/anomalyco/opentui) ⭐ 13,241 | 🐛 130 | 🌐 TypeScript | 📅 2026-09-04 - The main OpenTUI project.
...
* [hunk](https://github.com/modem-dev/hunk) ⭐ 9,107 | 🐛 159 | 🌐 TypeScript | 📅 2026-09-05 - Review-first terminal diff viewer for agentic coders.
* [tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,303 | 🐛 72 | 🌐 Rust | 📅 2026-09-05 - A terminal interface for tracking token usage.
...
* [ghui](https://github.com/kitlangton/ghui) ⭐ 1,099 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-02 - A terminal UI for managing open GitHub pull requests across repositories.
...
* [termdraw](https://github.com/benvinegar/termdraw) ⭐ 310 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-05 - A terminal drawing editor for editable diagrams, UI mocks, and text graphics.
...
* [gloomberb](https://github.com/gloom-sh/gloomberb) ⭐ 2,038 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-05 - Financial terminal using OpenTUI for the layout.
