...
* [OpenTUI](https://github.com/anomalyco/opentui) ⭐ 13,180 | 🐛 139 | 🌐 TypeScript | 📅 2026-08-30 - The main OpenTUI project.
...
* [hunk](https://github.com/modem-dev/hunk) ⭐ 8,927 | 🐛 140 | 🌐 TypeScript | 📅 2026-08-30 - Review-first terminal diff viewer for agentic coders.
* [tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,215 | 🐛 63 | 🌐 Rust | 📅 2026-08-30 - A terminal interface for tracking token usage.
...
* [termdraw](https://github.com/benvinegar/termdraw) ⭐ 304 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-16 - A terminal drawing editor for editable diagrams, UI mocks, and text graphics.
...
* [gloomberb](https://github.com/gloom-sh/gloomberb) ⭐ 2,012 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-30 - Financial terminal using OpenTUI for the layout.
* [tfm-tui](https://github.com/clarkarch/tfm-tui) ⭐ 70 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-30 - A mouse-first terminal file manager with grid views, drag and drop, image thumbnails, and desktop integration.
