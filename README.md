...
* [OpenTUI](https://github.com/anomalyco/opentui) ⭐ 13,316 | 🐛 142 | 🌐 TypeScript | 📅 2026-09-16 - The main OpenTUI project.
...
* [hunk](https://github.com/modem-dev/hunk) ⭐ 9,307 | 🐛 166 | 🌐 TypeScript | 📅 2026-09-14 - Review-first terminal diff viewer for agentic coders.
* [tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,453 | 🐛 65 | 🌐 Rust | 📅 2026-09-15 - A terminal interface for tracking token usage.
...
* [gloomberb](https://github.com/gloom-sh/gloomberb) ⭐ 2,149 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-16 - Financial terminal using OpenTUI for the layout.
* [tfm-tui](https://github.com/clarkarch/tfm-tui) ⭐ 170 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-16 - A mouse-first terminal file manager with grid views, drag and drop, image thumbnails, and desktop integration.
