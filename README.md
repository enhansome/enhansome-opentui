...
* [OpenTUI](https://github.com/anomalyco/opentui) ⭐ 13,266 | 🐛 133 | 🌐 TypeScript | 📅 2026-09-08 - The main OpenTUI project.
...
* [tuiparts.sh](https://github.com/tuiparts/tuiparts) ⭐ 256 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-02 - Primitive and recipe ecosystem for OpenTUI applications.
...
* [hunk](https://github.com/modem-dev/hunk) ⭐ 9,169 | 🐛 153 | 🌐 TypeScript | 📅 2026-09-08 - Review-first terminal diff viewer for agentic coders.
* [tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,356 | 🐛 68 | 🌐 Rust | 📅 2026-09-08 - A terminal interface for tracking token usage.
...
* [ghui](https://github.com/kitlangton/ghui) ⭐ 1,104 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-02 - A terminal UI for managing open GitHub pull requests across repositories.
...
* [termdraw](https://github.com/benvinegar/termdraw) ⭐ 309 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-08 - A terminal drawing editor for editable diagrams, UI mocks, and text graphics.
...
* [gloomberb](https://github.com/gloom-sh/gloomberb) ⭐ 2,083 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-08 - Financial terminal using OpenTUI for the layout.
