...
* [OpenTUI](https://github.com/anomalyco/opentui) ⭐ 13,343 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-19 - The main OpenTUI project.
...
* [hunk](https://github.com/modem-dev/hunk) ⭐ 9,343 | 🐛 168 | 🌐 TypeScript | 📅 2026-09-17 - Review-first terminal diff viewer for agentic coders.
* [tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,486 | 🐛 65 | 🌐 Rust | 📅 2026-09-18 - A terminal interface for tracking token usage.
...
* [tuiboard](https://github.com/NazzarenoGiannelli/tuiboard) ⭐ 116 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-19 - A terminal kanban board over plain markdown files, with a planner, a calendar-aware agenda, and a live Claude Code session view.
...
* [gloomberb](https://github.com/gloom-sh/gloomberb) ⭐ 2,161 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-19 - Financial terminal using OpenTUI for the layout.
* [tfm-tui](https://github.com/clarkarch/tfm-tui) ⭐ 217 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18 - A mouse-first terminal file manager with grid views, drag and drop, image thumbnails, and desktop integration.
