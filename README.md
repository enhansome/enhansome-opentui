...
* [OpenTUI](https://github.com/anomalyco/opentui) ⭐ 13,310 | 🐛 148 | 🌐 TypeScript | 📅 2026-09-15 - The main OpenTUI project.
...
* [tuiparts.sh](https://github.com/tuiparts/tuiparts) ⭐ 258 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-02 - Primitive and recipe ecosystem for OpenTUI applications.
...
* [pilotty](https://github.com/msmps/pilotty) ⭐ 156 | 🐛 3 | 🌐 Rust | 📅 2026-07-11 - Terminal equivalent of Vercel's agent-browser - CLI that enables AI agents to automate and control TUI applications.

## Developer Tools

* [hunk](https://github.com/modem-dev/hunk) ⭐ 9,289 | 🐛 162 | 🌐 TypeScript | 📅 2026-09-14 - Review-first terminal diff viewer for agentic coders.
* [tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,440 | 🐛 63 | 🌐 Rust | 📅 2026-09-15 - A terminal interface for tracking token usage.
* [critique](https://github.com/remorses/critique) ⭐ 1,274 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-02 - A terminal interface for reviewing Git changes.
* [ghui](https://github.com/kitlangton/ghui) ⭐ 1,111 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-02 - A terminal UI for managing open GitHub pull requests across repositories.
* [waha-tui](https://github.com/muhammedaksam/waha-tui) ⭐ 395 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-10 - A terminal user interface for WAHA (WhatsApp HTTP API).
* [termdraw](https://github.com/benvinegar/termdraw) ⭐ 309 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-10 - A terminal drawing editor for editable diagrams, UI mocks, and text graphics.
...
* [gloomberb](https://github.com/gloom-sh/gloomberb) ⭐ 2,148 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-15 - Financial terminal using OpenTUI for the layout.
* [tfm-tui](https://github.com/clarkarch/tfm-tui) ⭐ 90 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-15 - A mouse-first terminal file manager with grid views, drag and drop, image thumbnails, and desktop integration.
