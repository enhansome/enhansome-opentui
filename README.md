...
* [termdraw](https://github.com/benvinegar/termdraw) ⭐ 283 | 🐛 7 | 🌐 TypeScript | 📅 2026-05-19 - A terminal drawing editor for editable diagrams, UI mocks, and text graphics.
* [tuiboard](https://github.com/NazzarenoGiannelli/tuiboard) ⭐ 105 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-31 - A terminal kanban board over plain markdown files, with a planner, a calendar-aware agenda, and a live Claude Code session view.
* [cftop](https://github.com/NWBY/cftop) ⭐ 73 | 🐛 6 | 🌐 TypeScript | 📅 2025-11-23 - A terminal interface for Cloudflare Workers.
