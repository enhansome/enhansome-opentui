...
* [OpenTUI](https://github.com/anomalyco/opentui) ⭐ 13,349 | 🐛 148 | 🌐 TypeScript | 📅 2026-09-19 - The main OpenTUI project.
...
* [hunk](https://github.com/modem-dev/hunk) ⭐ 9,345 | 🐛 168 | 🌐 TypeScript | 📅 2026-09-20 - Review-first terminal diff viewer for agentic coders.
* [tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,491 | 🐛 70 | 🌐 Rust | 📅 2026-09-18 - A terminal interface for tracking token usage.
...
* [tuiboard](https://github.com/NazzarenoGiannelli/tuiboard) ⭐ 116 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-20 - A terminal kanban board over plain markdown files, with a planner, a calendar-aware agenda, and a live Claude Code session view.
...
* [gloomberb](https://github.com/gloom-sh/gloomberb) ⭐ 2,164 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-20 - Financial terminal using OpenTUI for the layout.
* [tfm-tui](https://github.com/clarkarch/tfm-tui) ⭐ 226 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-20 - A mouse-first terminal file manager with grid views, drag and drop, image thumbnails, and desktop integration.
